            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu sub-menu">
                    <?php foreach($nav_kampung as $nav_kampung) { ?>
                        <li class="sub-active"><a href="<?php echo base_url('kampung/kampung/'.$nav_kampung->slug_kampung) ?>"><i class="fad fa-angle-double-right mr-2" aria-hidden="true"></i> <?php echo $nav_kampung->judul_kampung ?></a></li>
                        <?php } ?> 
                    </ul>
                </li>
