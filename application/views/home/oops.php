...
<div class="section-header text-left">
    ...
    <p class="alert alert-success">Oops... Mohon maaf, halaman tidak ditemukan.<br><br> <a href="<?php echo base_url() ?>" class="btn btn-warning"><i class="fad fa-home"></i> Kembali ke Beranda</a></p>
</div>
<!-- .section-header -->
<div class="row">
